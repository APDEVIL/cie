...
// src/app/cie-pathway/[id]/page.tsx
...
export default function CiePathwayDetailPage() {
  ...
  if (!data) {
    return (
      <div className="space-y-4">
        <PageHeader title="Record Not Found" backHref="/cie-pathway" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-2">
        <Link href={`/cie-pathway/${recordId}/edit`}>
        ...
        <DeleteDialog
          label={`${data.student?.name ?? "this"}'s pathway record`}
      ...
      <Card className="max-w-2xl">
        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-x-6 gap-y-4 text-sm">
            ...
            <div>
              <dt className="text-xs font-medium uppercase tracking-wider text-muted-foreground">Assessment Component</dt>
              <dd className="mt-1">
